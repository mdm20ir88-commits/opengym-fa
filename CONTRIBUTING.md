...
| You have | Goes to |
| --- | --- |
| A question, or self-hosting that won't behave | [Discussions → Q&A](https://github.com/Jenesyx/opengym-fa/discussions/categories/q-a) |
| An idea you're not sure about yet | [Discussions → Ideas](https://github.com/Jenesyx/opengym-fa/discussions/categories/ideas) |
| A reproducible bug | [Issues](https://github.com/Jenesyx/opengym-fa/issues) |
