...
- 🤖 **Android APK, no Play Store.** The official build is a signed, sideloadable APK
  (~4.5 MB) from [Jenesyx/opengym-fa Releases](https://github.com/Jenesyx/opengym-fa/releases) — deliberately
...
- ▶️ **Project repository** at [github.com/Jenesyx/opengym-fa](https://github.com/Jenesyx/opengym-fa) —
...
- 🐳 Docker images use `ghcr.io/jenesyx/opengym-fa-{api,web}` (amd64 + arm64)
